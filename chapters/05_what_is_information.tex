...
\begin{question}What exactly is information? Can it be measured, like mass or energy?\end{question}

\begin{highlightbox}[The Core Question]Is there a universal, quantitative measure of information — independent of meaning, language, or medium — that captures the fundamental limits of communication and compression?\end{highlightbox}

\begin{connectionbox}[Connection to Thermodynamics]
...
\begin{roadblockbox}[The Meaning Barrier]
...
\begin{roadblockbox}[The Circularity Objection]
...
\begin{historicalbox}[Claude Shannon (1916--2001)]
...
\begin{highlightbox}[Shannon's Personality]
...
\begin{mentalLeap}[The Insight]Information is not \emph{meaning} — it is \emph{choice}. The information content of a message is the logarithm of the number of \emph{equally likely alternatives} it selects from. A message that eliminates more uncertainty carries more information. Meaning is irrelevant; only the \emph{probability distribution} of possible messages matters.\end{mentalLeap}
...
\begin{highlightbox}[Hartley's Anticipation]
...
\begin{highlightbox}[The Blahut--Arimoto Algorithm]
...
\begin{connectionbox}[Connection to Gordon Moore]
...
%======================================================================
\section{Citations}
\label{sec:information:citations}

\begin{enumerate}
  \item \cite{Shannon1948}
  \item \cite{Shannon1949}
  \item \cite{Shannon1959}
  \item \cite{coverthomas2006}
  \item \cite{mackay2003}
  \item \cite{gallager1968}
  \item \cite{Berrou1993}
  \item \cite{Arikan2009}
  \item \cite{tishby1999}
  \item \cite{landauer1961}
  \item \cite{stone2015}
  \item \cite{slepian1973}
  \item \cite{shannon1950}
  \item \cite{golomb2001}
\end{enumerate}
