...
\begin{question}Why are thousands of seemingly different problems — from logic (SAT) to graphs (Clique, Coloring) to numbers (Subset Sum, Factoring) to games (Chess, Go) — actually \emph{the same problem} in disguise?\end{question}
...
\begin{roadblockbox}[The Fragmentation Barrier]
...
\begin{roadblockbox}[The ``No Universal Solver'' Dogma]
...
\begin{historicalbox}[The Convergence of 1971--1973]
\begin{itemize}
...
\begin{historicalbox}[The Precursors]
\begin{itemize}
...
\begin{connectionbox}[Connection to Chapter 8]
...
\begin{mentalLeap}[Cook's Leap (1971)]\emph{Any non-deterministic polynomial-time computation can be encoded as a Boolean formula.}\end{mentalLeap}
...
\begin{mentalLeap}[Karp's Leap (1972)]\emph{NP-completeness is not a curiosity — it's the \emph{normal} state of NP problems.}\end{mentalLeap}
...
\begin{mentalLeap}[Levin's Leap (1973)]\emph{Universal search and average-case completeness.}\end{mentalLeap}
...
\begin{historicalbox}[Why the Cook-Levin Theorem Is Not Obvious]
...
\begin{roadblockbox}[The Gadget Design Principle]
...
\begin{historicalbox}[The Influence of Karp's 1972 Paper]
...
\begin{connectionbox}[NP-Intermediate Problems and Cryptography]
...
\begin{roadblockbox}[The Counting Barrier]
...
\begin{historicalbox}[The Long Road to the PCP Theorem]
...
\begin{roadblockbox}[Status of the UGC]
...
\begin{connectionbox}[Parameterized Complexity and Practical Algorithms]
...
\begin{roadblockbox}[The SETH Barrier]
...
\begin{historicalbox}[Feasible Interpolation and Cryptography]
...
\begin{roadblockbox}[Barriers to Resolving P vs NP]
...
\item Chapter 12 (Consensus): Byzantine agreement relates to NP-hard problems in synchronous models.
\item Chapter 12 (Interactive Proofs): Streaming algorithms for NP-hard problems (approximation via PCP/AM).
...
%======================================================================
\section{Citations}
\label{sec:np:citations}

\begin{enumerate}
  \item \cite{Cook1971}
  \item \cite{Karp1972}
  \item \cite{Levin1973}
  \item \cite{gareyjohnson1979}
  \item \cite{arorasafra1998}
  \item \cite{hastad2001}
  \item \cite{khot2002}
  \item \cite{DowneyFellows2013}
  \item \cite{Williams2018}
  \item \cite{RazborovRudich1997}
  \item \cite{Valiant1979}
  \item \cite{Raghavendra2008}
  \item \cite{Toda1991}
  \item \cite{Dinur2007}
  \item \cite{Babai2016}
  \item \cite{Feige1998}
  \item \cite{Daskalakis2006}
  \item \cite{Bringmann2014}
  \item \cite{Hrubes2019}
  \item \cite{MarquesSilva1999}
\end{enumerate}
