...
\begin{question}How can secrecy exist in a public world? Can two parties communicate securely over a channel that anyone can listen to — without any prior shared secret?\end{question}
...
\begin{roadblockbox}[The Key Distribution Problem]
...
\begin{roadblockbox}[The Symmetry Dogma]
...
\begin{historicalbox}[The 1970s Revolution]
\begin{itemize}
...
\begin{historicalbox}[Biographical Sketch: Whitfield Diffie]
...
\begin{historicalbox}[Biographical Sketch: Martin Hellman]
...
\begin{historicalbox}[Biographical Sketch: Ralph Merkle]
...
\begin{historicalbox}[Biographical Sketch: Ron Rivest]
...
\begin{historicalbox}[Biographical Sketch: Adi Shamir]
...
\begin{historicalbox}[Biographical Sketch: Leonard Adleman]
...
\begin{historicalbox}[Biographical Sketch: Neal Koblitz]
...
\begin{historicalbox}[Biographical Sketch: Victor Miller]
...
\begin{connectionbox}[Connection to Chapters 8 \& 9]
...
\begin{connectionbox}[The Common Thread]
...
\begin{highlightbox}[Average-Case vs Worst-Case Hardness]
...
\begin{roadblockbox}[Textbook RSA is Insecure]
...
\begin{highlightbox}[The Nonce Reuse Catastrophe]
...
\begin{roadblockbox}[The Implementation Gap]
...
\begin{connectionbox}[Connection to the Philosophy of Mathematics]
...
\item \textbf{Post-Quantum (NIST 2024):} \textbf{ML-KEM (Kyber)} for KEM, \textbf{ML-DSA (Dilithium)} for signatures, \textbf{SLH-DSA (SPHINCS+)} for hash-based sigs. FN-DSA (Falcon) for lattice-based signatures with smaller bandwidth. CROSS and LESS for additional signature diversity. Deployments already underway: Google Chrome hybrid Kyber+X25519, Cloudflare, SSH, Signal.
...
%======================================================================
\section{Citations}
\label{sec:crypto:citations}

\begin{enumerate}
  \item \cite{Shannon1949}
  \item \cite{DiffieHellman1976}
  \item \cite{RSA1978}
  \item \cite{ElGamal1985}
  \item \cite{Koblitz1987}
  \item \cite{Miller1985}
  \item \cite{GoldwasserMicali1984}
  \item \cite{BonehFranklin2001}
  \item \cite{Gentry2009}
  \item \cite{NISTPQC2024}
  \item \cite{Merkle1978}
  \item \cite{Regev2005}
  \item \cite{BonehLynnShacham2001}
  \item \cite{Yao1982}
  \item \cite{GoldreichMicaliWigderson1987}
  \item \cite{Damgard1991}
  \item \cite{Bernstein2006}
  \item \cite{Canetti2001}
  \item \cite{BellareRogaway1994}
  \item \cite{Kocher1996}
  \item \cite{Shor1994}
  \item \cite{ImpagliazzoLuby1989}
  \item \cite{Beullens2022}
  \item \cite{CastryckDecru2022}
\end{enumerate}
