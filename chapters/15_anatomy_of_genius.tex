...
\item \textbf{Recursion Theorem (Ch. 1):} $U(\langle M \rangle, x) = M(x)$. Every Turing machine can obtain its own description and simulate itself the programming-language equivalent of self-awareness.
...
%======================================================================
% SECTION 10: CASE STUDIES APPLYING THE PATTERNS
%======================================================================
