...
Hungarian-American computer scientist. Graph isomorphism in quasipolynomial time (2015). Co-proved MIP = NEXP (with Fortnow and Lund). Pioneer of interactive proofs and probabilistically checkable proofs.
...
\section*{Dantzig, George (1914--2005)}
...
American computer scientist. Differential privacy (2006, with McSherry, Nissim, and Smith) gave statistical privacy its first rigorous definition. Earlier work with Lynch and Stockmeyer (1988) introduced the partial synchrony model for consensus. Chief Scientist of the US Census Bureau (2014--2020), she led the adoption of differential privacy for the 2020 US Census.
...
American computer scientist. Descriptive complexity (1974): NP = $\exists$SO (existential second-order logic). Fagin's theorem connects logic and complexity. SIGMOD Edgar F. Codd Innovations Award 2004 (with S. Abiteboul, V. Vianu).
