% Appendix E: Guide for Further Reading
...
\subsection{Chapter 14: Randomized Computation}
\begin{itemize}
\item \textbf{Complexity Classes:} Gill (1977) RP, coRP, ZPP, BPP; Adleman (1978) BPP $\subseteq$ P/poly; Sipser (1983) \& Lautemann (1983) BPP $\subseteq \Sigma_2$
\item \textbf{Primality Testing:} Miller (1976); Rabin (1980); Agrawal--Kayal--Saxena (2004) AKS deterministic primality
\item \textbf{Textbooks:} Motwani \& Raghavan, \emph{Randomized Algorithms} (1995); Mitzenmacher \& Upfal, \emph{Probability and Computing} (2005); Karp (1991) ``An Introduction to Randomized Algorithms''
\item \textbf{Derandomization:} Nisan \& Wigderson (1994) hardness vs.\ randomness; Impagliazzo \& Wigderson (1997) BPP $=$ P under exponential hardness; Kabanets \& Impagliazzo (2004) barriers
\item \textbf{Randomness from Hardness:} Blum \& Micali (1984); H\aa{}stad--Impagliazzo--Levin--Luby (1999) PRGs from one-way functions
\item \textbf{Algebraic Randomness:} Freivalds (1977) matrix verification; Schwartz (1980) \& Zippel (1979) polynomial identity testing
\end{itemize}
...
\subsection{Chapter 15: Differential Privacy}
\begin{itemize}
\item \textbf{Foundational Papers:} Dwork, McSherry, Nissim \& Smith (2006) ``Calibrating Noise to Sensitivity in Private Data Analysis'' (TCC); Dwork (2006) ``Differential Privacy'' (ICALP); McSherry \& Talwar (2007) ``Mechanism Design via Differential Privacy'' (STOC)
\item \textbf{Primary Reference:} Dwork \& Roth (2014) \emph{The Algorithmic Foundations of Differential Privacy} (Foundations and Trends in Theoretical Computer Science)
\item \textbf{Privacy-Preserving ML:} Abadi et al. (2016) ``Deep Learning with Differential Privacy''; Mironov (2017) ``R\'enyi Differential Privacy''
\item \textbf{History and Context:} Warner (1965) randomized response; Sweeney (2002) $k$-anonymity; Dinur \& Nissim (2003) reconstruction lower bound
\item \textbf{Deployments:} Google RAPPOR (Erlingsson et al.\ 2014); US Census Bureau (2020) differentially private census disclosures
\item \textbf{Blog / Online:} ``Differential Privacy'' (CTF writeups and tutorials); Katz \& Lindell \emph{Introduction to Modern Cryptography} (privacy-adjacent foundations)
\end{itemize}

\subsection{Chapter 16: The Anatomy of Human Genius}
\begin{itemize}
