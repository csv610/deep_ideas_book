% Appendix B: Timeline of Major Discoveries
...
\item 1960: Solomonoff: Algorithmic probability; Rabin: Degree of difficulty
\item 1963: Gallager: LDPC codes
\item 1965: Hartmanis-Stearns (complexity classes); Edmonds (P = tractable); Cobham (intrinsic difficulty)
\item 1966: Martin-Löf: Random sequences
...
\item 1978: Lamport: Logical clocks; Morris: Approximate counting; Merkle: Thesis (Merkle trees)
...
\item 1983: Ben-Or: Randomized consensus; Rabin: Randomized Byzantine; Dolev-Strong: Authenticated Byzantine ($n>2t$)
\item 1985: Fischer-Lynch-Paterson: FLP Impossibility; Goldreich-Micali-Wigderson: NP $\subseteq$ CZK; Flajolet-Martin: Probabilistic counting (PCSA); ElGamal: Encryption/signatures
...
\item 1988: Ben-Or-Goldwasser-Kilian-Wigderson: Multi-prover IP (MIP); Dwork-Lynch-Stockmeyer: Partial synchrony
\item 1990: Babai-Fortnow-Lund: MIP = NEXP; Shamir: IP = PSPACE
