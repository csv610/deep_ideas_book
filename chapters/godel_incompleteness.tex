...
Is there a formal system that captures all mathematical truth? Or are there true statements that can never be proven within the system? And can a system prove its own consistency?
