...
\begin{itemize}
\item Chapter 2 (Halting): Special case of Rice's Theorem; the arithmetical hierarchy and Turing degrees developed there give the precise classification of index sets used in this chapter.
...
\item Chapter 4, Section 6.5 (Abstract Interpretation): The positive response to Rice's Theorem --- sound over-approximation via Galois connections, widening, and narrowing, discussed within this chapter.
\end{itemize}
