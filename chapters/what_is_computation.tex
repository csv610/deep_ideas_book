...
The question ``What is computation?'' did not arise in a vacuum. It grew from two millennia of work on algorithmic problem-solving --- from Euclid's algorithm (circa 300 BCE) to al-Khw\=arizm\=i's algebra (circa 820 CE) to Leibniz's \emph{calculus ratiocinator} (1666) to Babbage's Analytical Engine (1837). Each of these was a precursor to the formal question Turing answered.
